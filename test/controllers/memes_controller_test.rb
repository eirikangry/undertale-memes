...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post memes_url, params: { meme: { image: @meme.image, poster: @meme.poster, title: @meme.title } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { image: @meme.image, poster: @meme.poster, title: @meme.title } }
